...
# It mutates the second argument but not the first
...
# The string rutabaga is concat'd on the end of the string pumpkins which is mutated.  the arr is unaffected becasue of reassignment.
...
# the conditional evaluates to true no need for the if else true false control flow.